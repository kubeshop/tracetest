...
id: datadog
title: Datadog
description: Use Datadog as the trace data store for Tracetest. Configure the OpenTelemetry Collector to receive traces and forward them to both Tracetest and Datadog.
keywords:
  - tracetest
  - trace-based testing
  - observability
...
:::tip
To learn more, [read the recipe for running a sample app with Datadog and Tracetest](/examples-tutorials/recipes/running-tracetest-with-datadog).
:::
