...
Once you've installed Tracetest, as explained in the [installation guide](./installation.mdx), you access the Tracetest Web UI on [`cloud.tracetest.io`](https://cloud.tracetest.io). Here's what will greet you after a fresh install.
