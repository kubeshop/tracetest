...
:::note 
Playwright enables an exceptionaly useful technique: true end-to-end testing, when you can start you test from the web UI and explore the entire intenal process of that request.
:::
