...
We recommend using [Tracetest Cloud](https://cloud.tracetest.io/), our managed platform for Tracetest, because it's the easiest way to build and test with OpenTelemetry. Tracetest Cloud includes features such as collaboration for teams and comes with a free tier for development.
