---
id: importing-tests-definition
title: Importing Tests from a Tracetest Definition
description: Tracetest enables importing tests from a Tracetest Definition visually in the Tracetest Web UI.
...
![Choose Import Method](../img/import-select-method-definition-0.14.png)

Input a valid Tracetest Definition using **JSON** or **YAML**:

![Paste Definition](../img/import-definition-yaml-0.14.png)
...
![After Import Definition](../img/import-definition-create-0.14.png)
