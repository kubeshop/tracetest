...
id: expressions
title: Expressions
description: Expressions are used to add values that are only known during execution time. Build integration and end-to-end tests with OpenTelemetry traces with Tracetest.
