...
id: assertions
title: Assertions
description: Assertions are added to set a value for a step in the trace to determine success or failure. Build integration and end-to-end tests with OpenTelemetry traces with Tracetest.
keywords:
  - tracetest
  - trace-based testing
  - observability
