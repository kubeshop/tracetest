...
It allows you to run Tracetest tests against public facing endpoints without deploying the Tracetest Agent. This allows you to trigger tests against public endpoints and collect trace data from either public tracing backends or, alternatively, directly receive incoming OTLP data.
