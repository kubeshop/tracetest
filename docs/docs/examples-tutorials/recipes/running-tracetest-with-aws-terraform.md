...
The infrastructure required to run the serverless API can be find as part of the `api.tf` file.
...
The latest version of Jager supports enabling OpenTelemetry endpoints by including the following:
