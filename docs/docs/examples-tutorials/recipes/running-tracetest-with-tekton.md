# Tracetest and Tekton - Running Event-driven Trace-based Tests
...
Install Tekton Pipelines by following [these instructions](https://tekton.dev/docs/getting-started/tasks/#install-tekton-pipelines), or running the command below.
