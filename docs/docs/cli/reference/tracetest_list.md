...
```
tracetest list analyzer|config|datastore|demo|env|environment|organization|organizationinvite|pollingprofile|test|testrunner|testsuite|token|variableset [flags]
```
