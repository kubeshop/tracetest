...
const (
	...
	Orchestrator_RegisterGraphqlIntrospectListener_FullMethodName    = "/proto.Orchestrator/RegisterGraphqlIntrospectListener"
	Orchestrator_SendGraphqlIntrospectResult_FullMethodName          = "/proto.Orchestrator/SendGraphqlIntrospectResult"
)
...
func (c *orchestratorClient) RegisterGraphqlIntrospectListener(ctx context.Context, in *AgentIdentification, opts ...grpc.CallOption) (Orchestrator_RegisterGraphqlIntrospectListenerClient, error) {
	stream, err := c.cc.NewStream(ctx, &Orchestrator_ServiceDesc.Streams[6], Orchestrator_RegisterGraphqlIntrospectListener_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *orchestratorClient) SendGraphqlIntrospectResult(ctx context.Context, in *GraphqlIntrospectResponse, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Orchestrator_SendGraphqlIntrospectResult_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Orchestrator_SendGraphqlIntrospectResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Orchestrator_SendGraphqlIntrospectResult_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
