...
import {COMMUNITY_URL, OCTOLIINT_ISSUE_URL} from 'constants/Common.constants';
  ...
  return (
    <S.Container>
      ...
      <S.Description>
        ...
        We value your feedback on this beta release. Share your thoughts on <a href={COMMUNITY_URL}>Slack</a> or add
