  ...
  return (
    <S.EmptyAttributeList data-cy="empty-attribute-list">
      ...
      <S.EmptyText>
        ...
        <a href={TRACE_SEMANTIC_CONVENTIONS_URL}>trace semantic conventions</a> and here for{' '}
        <a href={RESOURCE_SEMANTIC_CONVENTIONS_URL}>resource semantic conventions</a>.
      </S.EmptyText>
