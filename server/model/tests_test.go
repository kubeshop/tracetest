...
func TestDefinition(t *testing.T) {
	t.Run("Add", func(t *testing.T) {
		...
		def, err := def.Add(model.SpanQuery("1"), []model.Assertion{{"1", comparator.Eq, createExpressionFromNumber("1")}})
		require.NoError(t, err)

		def, err = def.Add(model.SpanQuery("2"), []model.Assertion{{"2", comparator.Eq, createExpressionFromNumber("2")}})
		require.NoError(t, err)
	...
	generateDef := func() model.OrderedMap[model.SpanQuery, []model.Assertion] {
		...
		def, _ = def.Add(model.SpanQuery("1"), []model.Assertion{{"1", comparator.Eq, createExpressionFromNumber("1")}})
		def, _ = def.Add(model.SpanQuery("2"), []model.Assertion{{"2", comparator.Eq, createExpressionFromNumber("2")}})
