...
func TestCreateTransaction(t *testing.T) {
	...
	// TODO: check steps
	// assert.Equal(t, transaction.Steps, actual.Steps)
}
...
func TestGetLatestTransactionVersion(t *testing.T) {
	...
	latestTest, err := db.GetLatestTestVersion(context.TODO(), transaction.ID)
...
// 		_, _ = db.CreateTransaction(context.TODO(), model.Test{Name: "VerySpecificName"})
...
// 		_, _ = db.CreateTransaction(context.TODO(), model.Test{Description: "VeryUniqueText"})
...
// 	_, err := db.UpdateTransaction(context.TODO(), test1)
// 	require.NoError(t, err)

// 	test2 := createTestWithName(t, db, "2")
// 	test2.Name = "2 v2"

// 	_, err = db.UpdateTransaction(context.TODO(), test2)
// 	require.NoError(t, err)
