...
type ResourceApiApiRouter interface {
	...
	CreateLintern(http.ResponseWriter, *http.Request)
	...
	DeleteLintern(http.ResponseWriter, *http.Request)
	...
	GetLintern(http.ResponseWriter, *http.Request)
	...
	ListLinterns(http.ResponseWriter, *http.Request)
	...
	UpdateLintern(http.ResponseWriter, *http.Request)
...
type ResourceApiApiServicer interface {
	...
	CreateLintern(context.Context, LinternResource) (ImplResponse, error)
	...
	DeleteLintern(context.Context, string) (ImplResponse, error)
	...
	GetLintern(context.Context, string) (ImplResponse, error)
	...
	ListLinterns(context.Context, int32, int32, string, string) (ImplResponse, error)
	...
	UpdateLintern(context.Context, string, LinternResource) (ImplResponse, error)
