...
type ApiApiRouter interface {
	...
	GetTestVariables(http.ResponseWriter, *http.Request)
	...
	GetTransactionVariables(http.ResponseWriter, *http.Request)
...
type ApiApiServicer interface {
	...
	GetTestVariables(context.Context, string, int32, string, int32) (ImplResponse, error)
	...
	GetTransactionVariables(context.Context, string, int32, string, int32) (ImplResponse, error)
