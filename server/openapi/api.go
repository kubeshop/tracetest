...
type ApiApiRouter interface {
	...
	GetDataStoresConfig(http.ResponseWriter, *http.Request)
	...
	UpdateDataStoresConfig(http.ResponseWriter, *http.Request)
...
type ApiApiServicer interface {
	...
	GetDataStoresConfig(context.Context) (ImplResponse, error)
