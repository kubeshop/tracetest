...
type RunRepository interface {
	Create(context.Context, Test, Run) (Run, error)
	Update(context.Context, Run) error
	Delete(context.Context, Run) error
	Get(_ context.Context, testID id.ID, runID int) (Run, error)
	List(_ context.Context, _ Test, take, skip int32) ([]Run, error)
	GetByTraceID(context.Context, trace.TraceID) (Run, error)
	GetLatestByTestVersion(context.Context, id.ID, int) (Run, error)
}
...
func (td *runRepository) Create(ctx context.Context, test Test, run Run) (Run, error) {
	run.TestID = test.ID
	...
	return td.Get(ctx, test.ID, runID)
}
...
func (td *runRepository) Update(ctx context.Context, r Run) error {
...
func (td *runRepository) Delete(ctx context.Context, r Run) error {
	queries := []string{
...
func (td *runRepository) Get(ctx context.Context, testID id.ID, runID int) (Run, error) {
...
func (td *runRepository) List(ctx context.Context, test Test, take, skip int32) ([]Run, error) {
...
func (td *runRepository) GetByTraceID(ctx context.Context, traceID trace.TraceID) (Run, error) {
...
func (td *runRepository) GetLatestByTestVersion(ctx context.Context, testID id.ID, version int) (Run, error) {
...
func (td *runRepository) readRunRows(ctx context.Context, rows *sql.Rows) ([]Run, error) {
	var runs []Run
...
func readRunRow(row scanner) (Run, error) {
	...
	default:
		return Run{}, fmt.Errorf("read run row: %w", err)
	}
}

func (td *runRepository) GetTransactionRunSteps(ctx context.Context, tr transactions.TransactionRun) ([]Run, error) {
