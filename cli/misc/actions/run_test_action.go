...
type runTestAction struct {
	...
	environmentActions resources_actions.EnvironmentsActions
}
...
func NewRunTestAction(config config.Config, logger *zap.Logger, client *openapi.APIClient, environmentActions resources_actions.EnvironmentsActions) runTestAction {
